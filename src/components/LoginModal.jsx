...
const TabPanel = ({children, value, index}) => (
    <div hidden={value !== index} style={{padding: '12px 0'}}>
...
const LoginModal = ({open, onClose}) => {
    ...
    return (
        ...
        >
                         <DialogContent sx={{padding: '40px 80px 80px 80px', height: '100vh', display: 'flex', flexDirection: 'column'}}>
                

                {/* Tabs */}
                <Box sx={{borderBottom: 1, borderColor: '#E0E0E0', padding: 0}}>
                    <Tabs value={tabValue} onChange={handleTabChange} sx={{minHeight: '48px'}}>
                 ...
                 <TabPanel value={tabValue} index={0}>
                     <Box component="form" onSubmit={handleSubmit} sx={{padding: 0, display: 'flex', flexDirection: 'column', gap: 1}}>
                         <StyledTextField
                             fullWidth
                             label="Email"
                             type="email"
                ...
                <TabPanel value={tabValue} index={1}>
                    <Box component="form" onSubmit={handleSubmit} sx={{padding: 0, display: 'flex', flexDirection: 'column', gap: 2}}>
                                                 <StyledTextField
                             fullWidth
                             label="First name"
                        ...
                        />
                         ...
                         {errors.privacyPolicy && (
                             <Typography variant="caption" sx={{color: '#D32F2F', display: 'block', mb: 0.5}}>
                                 {errors.privacyPolicy}
                             </Typography>
                         )}
