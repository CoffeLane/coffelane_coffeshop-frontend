...
const Carousel2 = () => {
    ...
    return (
        <Box sx={{ position: "relative", overflow: "hidden", mx: 4, py: 6 }}>
            ...
            <IconButton onClick={handleNext} sx={{ position: "absolute", right: 0, top: "50%", transform: "translateY(-50%)", backgroundColor: "#A4795B", color: "#fff", borderRadius: "50px", zIndex: 1, "&:hover": { backgroundColor: "#B88A6E" }, }}>
                <ArrowForwardIos />
            </IconButton>
        </Box>
    );
